...
(defn page [request compose]
  (compose "Home" nil
    ...
    [:h3 "Technical Info"]
    [:p "Ocastio is currently hosted on a Raspberry Pi Zero (Wireless). The application runs on the JVM (Java Virtual Machine), written entirely in Clojure - a modern functional-paradigm programming language. The website is open source and can be found on " [:a {:href "https://github.com/phunanon/Ocastio"} "Github"] "."]
    [:h4 "About the author"]
