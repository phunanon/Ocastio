...
(defn page [request]
  (v/compose-page request "Home" nil
    ...
    [:h3 "Technical Info"]
    [:p "Ocastio is currently hosted on a Raspberry Pi Zero (Wireless). The application runs on the JVM (Java Virtual Machine), written entirely in Clojure - a modern functional-paradigm programming language. Source code will be open once largely operational, providing peace of mind."]
    [:h4 "About the author"]
