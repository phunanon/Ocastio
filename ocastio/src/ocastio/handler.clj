...
(defroutes app-routes
  ...
  (GET  "/con/:con_id"                req (rou/page req :con))
  (GET  "/con/new/:org_id"            req (rou/page req :con-new))
  (POST "/con/new/:org_id"            req (rou/post req :con-new))
  (POST "/con/add/:org-id"            req (rou/post req :con-mem))
